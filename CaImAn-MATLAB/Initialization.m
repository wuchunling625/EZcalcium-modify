...
%
%      INITIALIZATION('Property','Value',...) creates a new INITIALIZATION using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to Initialization_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      INITIALIZATION('CALLBACK') and INITIALIZATION('CALLBACK',hObject,...) call the
%      local function named CALLBACK in INITIALIZATION.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 01-Aug-2017 15:14:49

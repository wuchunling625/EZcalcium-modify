...
options_rigid = NoRMCorreSetParms('d1',size(Y,1),'d2',size(Y,2),'bin_width',200,'max_shift',20000,'us_fac',50,'init_batch',200);
...
options_nonrigid = NoRMCorreSetParms('d1',size(Y,1),'d2',size(Y,2),'bin_width',200,'max_shift',20000,'us_fac',50,'init_batch',200);
